...
import com.capone.processes.DecisionTableKieBaseProvider;
import com.capone.processes.DslKieBaseProvider;
...
public class RulesTest {
	...
	private static DslKieBaseProvider dslManager= new DslKieBaseProvider();
	...
	/*@Test
	public void testDecisionTableRules() {
		LOG.info("Testing with decision table");
		testRules(dtableManager.getKieBase(), "DSTWithDRL_ResultFile");
	}
	
	@Test
	public void testDslRules() {
		LOG.info("Testing with DSL");
		testRules(dslManager.getKieBase(), "DSL_ResultFile");
	}*/
