...
public class DecisionTableKieBaseProvider {
	...
	public DecisionTableKieBaseProvider() {
		...
		addResource(kieFileSystem, "com/capone/recordvalidation/populateRestrictions.xls");
		addResource(kieFileSystem, "com/capone/recordvalidation/validateFields.drl");
		addResource(kieFileSystem, "com/capone/recordvalidation/createRestrictions.drl");
